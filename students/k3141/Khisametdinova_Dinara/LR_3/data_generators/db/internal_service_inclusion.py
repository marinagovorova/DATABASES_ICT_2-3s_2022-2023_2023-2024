...
table_name = 'internal_service_inclusion'
column_names = ('internal_service_inclusion_id', 'internal_service_id', 'phone_number', 'date_of_connection', 'date_of_disconnection')
k = 101
...
with open('backups/internal_service_inclusion_backup.sql', 'w') as f: 
