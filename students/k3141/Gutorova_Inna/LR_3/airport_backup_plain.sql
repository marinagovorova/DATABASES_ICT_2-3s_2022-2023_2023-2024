...
-- Started on 2023-10-27 13:08:03
...
ALTER TABLE schema.employee ALTER COLUMN id_employee ADD GENERATED ALWAYS AS IDENTITY (
...
CREATE TABLE schema.route (
    ...
    date_and_time_departure timestamp with time zone NOT NULL,
    date_and_time_arrival timestamp with time zone NOT NULL,
...
--
-- TOC entry 4893 (class 0 OID 16436)
-- Dependencies: 229
...
--
-- TOC entry 4903 (class 0 OID 16469)
-- Dependencies: 239
...
COPY schema.crew (id_crew, status, allowance) FROM stdin;
1	Status 1	Allowance 1
2	Status 2	Allowance 2
3	Status 3	Allowance 3
\.


--
-- TOC entry 4891 (class 0 OID 16430)
-- Dependencies: 227
-- Data for Name: employee; Type: TABLE DATA; Schema: schema; Owner: postgres
--

COPY schema.employee (id_employee, surname, name, patronymic, passport_series, passport_number, passport_date, passport_who_issued, id_crew, id_company) FROM stdin;
46	Surname 1	Name 1	Patronymic 1	1234	566789	2023-01-01	Issuer 1	1	1
47	Surname 2	Name 2	Patronymic 2	5678	987765	2023-02-01	Issuer 2	2	2
48	Surname 3	Name 3	Patronymic 3	4321	123455	2023-03-01	Issuer 3	3	3
\.


--
-- TOC entry 4901 (class 0 OID 16463)
-- Dependencies: 237
...
--
-- TOC entry 4883 (class 0 OID 16406)
-- Dependencies: 219
...
--
-- TOC entry 4899 (class 0 OID 16452)
-- Dependencies: 235
...
COPY schema.route (id_route, type, date_and_time_departure, date_and_time_arrival, id_schedule, id_crew, id_plane) FROM stdin;
1	Domestic	2023-10-28 10:00:00+03	2023-10-28 12:00:00+03	1	1	1
2	International	2023-10-29 14:00:00+03	2023-10-29 18:00:00+03	2	2	2
3	Domestic	2023-10-30 08:00:00+03	2023-10-30 10:00:00+03	3	3	2
\.


--
-- TOC entry 4897 (class 0 OID 16446)
-- Dependencies: 233
...
--
-- TOC entry 4889 (class 0 OID 16424)
-- Dependencies: 225
...
--
-- TOC entry 4885 (class 0 OID 16412)
-- Dependencies: 221
...
1	Active	Paid	Business	Yes	Checked	1	1	1	1	100
2	Active	Paid	Economy	No	Not Checked	1	1	2	1	50
3	Pending	Not Paid	Business	Yes	Checked	2	3	3	3	150
\.


--
-- TOC entry 4881 (class 0 OID 16400)
-- Dependencies: 217
...
--
-- TOC entry 4708 (class 2606 OID 16440)
...
--
-- TOC entry 4718 (class 2606 OID 16473)
...
--
-- TOC entry 4706 (class 2606 OID 16434)
...
--
-- TOC entry 4716 (class 2606 OID 16467)
...
--
-- TOC entry 4698 (class 2606 OID 16410)
...
--
-- TOC entry 4714 (class 2606 OID 16456)
...
--
-- TOC entry 4696 (class 2606 OID 16404)
...
--
-- TOC entry 4700 (class 2606 OID 16558)
...
--
-- TOC entry 4731 (class 2606 OID 16532)
-- Name: transit fk_airport; Type: FK CONSTRAINT; Schema: schema; Owner: postgres
--

ALTER TABLE ONLY schema.transit
    ADD CONSTRAINT fk_airport FOREIGN KEY (id_airport) REFERENCES schema.airport(id_airport) NOT VALID;


--
-- TOC entry 4733 (class 2606 OID 16537)
-- Name: schedule fk_airport_arrival; Type: FK CONSTRAINT; Schema: schema; Owner: postgres
--

ALTER TABLE ONLY schema.schedule
    ADD CONSTRAINT fk_airport_arrival FOREIGN KEY (id_airport_arrival) REFERENCES schema.airport(id_airport) NOT VALID;
...
ALTER TABLE ONLY schema.schedule
    ADD CONSTRAINT fk_airport_departure FOREIGN KEY (id_airport_departure) REFERENCES schema.airport(id_airport) NOT VALID;


--
-- TOC entry 4729 (class 2606 OID 16520)
-- Name: employee fk_company; Type: FK CONSTRAINT; Schema: schema; Owner: postgres
--

ALTER TABLE ONLY schema.employee
    ADD CONSTRAINT fk_company FOREIGN KEY (id_company) REFERENCES schema.company(id_company) NOT VALID;
...
--
-- TOC entry 4725 (class 2606 OID 16505)
-- Name: route fk_crew; Type: FK CONSTRAINT; Schema: schema; Owner: postgres
--

ALTER TABLE ONLY schema.route
    ADD CONSTRAINT fk_crew FOREIGN KEY (id_crew) REFERENCES schema.crew(id_crew) NOT VALID;


--
-- TOC entry 4730 (class 2606 OID 16515)
-- Name: employee fk_crew; Type: FK CONSTRAINT; Schema: schema; Owner: postgres
--
...
--
-- TOC entry 4736 (class 2606 OID 16547)
-- Name: plane fk_model; Type: FK CONSTRAINT; Schema: schema; Owner: postgres
--

ALTER TABLE ONLY schema.plane
    ADD CONSTRAINT fk_model FOREIGN KEY (id_model) REFERENCES schema.model(id_model) NOT VALID;


--
-- TOC entry 4721 (class 2606 OID 16485)
-- Name: ticket fk_passenger; Type: FK CONSTRAINT; Schema: schema; Owner: postgres
--

ALTER TABLE ONLY schema.ticket
    ADD CONSTRAINT fk_passenger FOREIGN KEY (id_passenger) REFERENCES schema.passenger(id_passenger) NOT VALID;


--
-- TOC entry 4726 (class 2606 OID 16510)
-- Name: route fk_plane; Type: FK CONSTRAINT; Schema: schema; Owner: postgres
--

ALTER TABLE ONLY schema.route
    ADD CONSTRAINT fk_plane FOREIGN KEY (id_plane) REFERENCES schema.plane(id_plane) NOT VALID;
...
ALTER TABLE ONLY schema.seat
    ADD CONSTRAINT fk_route FOREIGN KEY (id_route) REFERENCES schema.route(id_route) NOT VALID;


--
-- TOC entry 4722 (class 2606 OID 16495)
...
ALTER TABLE ONLY schema.route
    ADD CONSTRAINT fk_schedule FOREIGN KEY (id_schedule) REFERENCES schema.schedule(id_schedule) NOT VALID;
...
--
-- TOC entry 4723 (class 2606 OID 16490)
-- Name: ticket fk_seat; Type: FK CONSTRAINT; Schema: schema; Owner: postgres
--

ALTER TABLE ONLY schema.ticket
    ADD CONSTRAINT fk_seat FOREIGN KEY (id_seat) REFERENCES schema.seat(id_seat) NOT VALID;
...
ALTER TABLE ONLY schema.ticket
    ADD CONSTRAINT fk_ticket_office FOREIGN KEY (id_ticket_office) REFERENCES schema.ticket_office(id_ticket_office) NOT VALID;


-- Completed on 2023-10-27 13:08:04
